...
instruction instructions[0x100] = {
    ...
    // 0x2X
    [0x20] = {.type = IN_JR, .mode = AM_D8, .cond = CT_NZ},
    ...
    [0x38] = {.type = IN_JR, .mode = AM_D8, .cond = CT_C},
    ...
    // 0xCX
    [0xC0] = {.type = IN_RET, .mode = AM_R, .cond = CT_NZ},
    [0xC1] = {.type = IN_POP, .mode = AM_R, .reg1 = RT_BC},
    [0xC3] = {.type = IN_JP, .mode = AM_D16},
    [0xC4] = {.type = IN_CALL, .mode = AM_D16, .cond = CT_NONE},
    [0xC5] = {.type = IN_PUSH, .mode = AM_R, .reg1 = RT_BC},
    [0xC8] = {.type = IN_RET, .mode = AM_R, .cond = CT_Z},
    [0xC9] = {.type = IN_RET, .mode = AM_R},
    [0xCA] = {.type = IN_JP, .mode = AM_D16, .cond = CT_Z},
    [0xCC] = {.type = IN_CALL, .mode = AM_D16, .cond = CT_Z},
    [0xCD] = {.type = IN_CALL, .mode = AM_D16, .cond = CT_NONE},

    // 0xDX
    [0xD0] = {.type = IN_RET, .mode = AM_R, .cond = CT_NC},
    [0xD1] = {.type = IN_POP, .mode = AM_R, .reg1 = RT_DE},
    [0xD5] = {.type = IN_PUSH, .mode = AM_R, .reg1 = RT_DE},
    [0xD8] = {.type = IN_RET, .mode = AM_R, .cond = CT_C},
    [0xD9] = {.type = IN_RETI, .mode = AM_R, .cond = CT_NONE},
