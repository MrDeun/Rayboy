...
Do implementacji emulatora zastosowano język C++ ze względu na jego niskopoziomową naturę, wraz z bibliotekami Raylib  w wersji 5.0 \cite{raylib} dla implementancji graficznej i sterowania oraz  fmt w wersji 10.2.1 \cite{fmt} dla łatwiejszego formatowanie tekstu.
...
Ze względu na bardzo specficzne implementację tabeli op-codów, nie wszytkie kompilatory C++ wspierają daną składnię - aktualnie tylko kompilator \textit{clang++} wspiera nieoznaczone inicjalizatory. 
\newpage
